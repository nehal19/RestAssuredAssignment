Feature: Test the response of the Specific Date Foreign Exchange rates

	Scenario: Assert the response of Specific Date Foriegn Exchange rates response
	Given Rates API for Specific Date Foreign Exchange rates
	When The API is available
	Then Verify that  the response body has base as "EUR"
	And Verify that the rate of INR is greater than 0
	
	Scenario: Assert the response of the response for Specific Date Foriegn Exchange with Symbol
	...
	Scenario: Assert the response of the response for Specific Date Foriegn Exchange with Base
	...
	Scenario: Assert the response of the response for Specific Date Foriegn Exchange with Symbol and Base
